...
def process_dls_files(directory):
    ...
    for curve in curves:
        ...
        ax.plot(x_valuesnorm, g1_values, label=f'{label} canales', color = colores[i])
        i=i+1
    ...
    ax.set_title(rf"Muestra 8, $\theta=90$°, Duración $40$ s, $\tau= 20$ $\mu s$", fontsize=14)

    #plt.show()
    plt.savefig("g2canales.png", format='png', dpi=500, bbox_inches = 'tight')

# Ejemplo de uso:
process_dls_files("canales")
